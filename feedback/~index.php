...
$form['form-7'] = array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Stilberg Oil',
		'title' => 'Покупка масла',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'admin2@stilberg-oil.ru',
		'from_name' => 'admin3@stilberg-oil.ru',
		'to_email' => '7286443@gmail.com, 6435181m@list.ru, zakaz@stilberg-oil.ru',
		'to_name' => 'Roman',
		'geoip' => true,
		'referer' => true,
		'type' => 'html',
...
$form['form-33'] = array(
	...
	'cfg' => array(
		...
		'antispam' => 'email77',
		'antispamjs' => 'address77',
		'okay' => 'Запрос стоимости отправлен',
		'fuck' => 'Сообщение отправлено - ERROR',
		'spam' => 'Cпам робот',
		'notify' => 'color-modal-textbox',
		'usepresuf' => false
...
if(isset($form[$act])) {
   ...
   $sb = array(); // subject и body
    ...
    if(count($error) == 0) {
      ...
      $get_fromEmail = (isset($form['fields'][$form['cfg']['from_email']]) && isset($getdata[$form['cfg']['from_email']]['value']) && mb_strpos('@', $getdata[$form['cfg']['from_email']]['value']) === false) ? $getdata[$form['cfg']['from_email']]['value'] : ((mb_strpos('@', $form['cfg']['from_email']) !== false) ? $form['cfg']['from_email'] : 'admin1@stilberg-oil.ru');
