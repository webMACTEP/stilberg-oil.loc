...
$form['form-7'] = array(
	...
	'cfg' => array(
		...
		'from_name' => 'Oil',
		'to_email' => '7286443@gmail.com, 6435181m@list.ru, wmail@bk.ru',
		'to_name' => 'Roman, Alex, Admin',
		'geoip' => true,
		'referer' => true,
		'type' => 'html',
		'tpl' => true,
...
if(isset($form[$act])) {
   ...
   $sb = array(); // subject и body
    ...
    if(count($error) == 0) {
      ...
      $get_fromEmail = (isset($form['fields'][$form['cfg']['from_email']]) && isset($getdata[$form['cfg']['from_email']]['value']) && mb_strpos('@', $getdata[$form['cfg']['from_email']]['value']) === false) ? $getdata[$form['cfg']['from_email']]['value'] : ((mb_strpos('@', $form['cfg']['from_email']) !== false) ? $form['cfg']['from_email'] : 'admin2@stilberg-oil.ru');
